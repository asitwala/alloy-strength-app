...
<div class="as-user-stats">
    ...
    <transition name="as-fade">
        <div class="as-user-stats-actual-content" v-if="!loading">
            ...
            <br>
            <p>The stats below represent your performance on <b>Alloy Sets</b> 
            for the primary exercise categories: <i>Hinge</i>, <i>Squat</i>, and <i>UB Hor Push</i>. These must be passed for you to proceed to the next level.</p>
